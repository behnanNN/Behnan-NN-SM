...
dir_names = os.listdir('/gs/gsfs0/users/abdubey/pw/storage/scRNAseq/2024_Analysis/scanpy_analysis/bm_sm_analysis_new/pydeseq2_analysis')
file_names = os.listdir('/gs/gsfs0/users/abdubey/pw/storage/scRNAseq/2024_Analysis/scanpy_analysis/bm_sm_analysis_new/pydeseq2_analysis/gl_bm_vs_sham_bm/1.2_log2FC_0.05_pval_cutoff')
cell_names = [x.split('.csv')[0] for x in file_names]
common_path = '/gs/gsfs0/users/abdubey/pw/storage/scRNAseq/2024_Analysis/scanpy_analysis/bm_sm_analysis_new/pydeseq2_analysis/'
...
for k in tqdm(list(genes_up_down_d)):
	fig,ax = plt.subplots(figsize=(8,14),nrows=5,ncols=3)
...
for i in list(genes_up_down_d):
	genes_up_down_d[i].to_csv('/gs/gsfs0/home/abdubey/pw/storage/scRNAseq/2024_Analysis/scanpy_analysis/bm_sm_analysis_new/pydeseq2_analysis/'+i+'/'+i+'_summary_up_down.csv')
...
path_to_save = '/gs/gsfs0/home/abdubey/pw/storage/scRNAseq/2024_Analysis/scanpy_analysis/bm_sm_analysis_new/pydeseq2_analysis/summary_plots_overlapping_genes/'
